...
#project items
ProjectItem.create(image_url: "../images/FlowersInHerHair1_thumb.jpg", image_name: "FlowersInHerHair1_thum", image_caption: "This is the main image", is_main_image: true, project: p)
ProjectItem.create(image_url: "../images/FlowersInHerHair1.jpg", image_name: "FlowersInHerHair1", is_main_image: false, project: p)
...
ProjectItem.create(image_url: "../images/FloralPatterns_TulipsAndRoses_800_thumb.png", image_name:"", is_main_image: true, project: p1)
ProjectItem.create(image_url: "../images/FloralPatterns_TulipsAndRoses_800.png", image_name:"", is_main_image: false, project: p1)
ProjectItem.create(image_url: "../images/FloralPatterns_Dahlias_800.png", image_name:"", is_main_image: false, project: p1)
ProjectItem.create(image_url: "../images/FloralPatterns_PinkPoppy_800.jpg", image_name:"", is_main_image: false, project: p1)
ProjectItem.create(image_url: "../images/FloralPatterns_RedRoses_800.jpg", image_name:"", is_main_image: false, project: p1)
...
ProjectItem.create(image_url: "../images/Thumb_CMBN_PortlandOR_800.jpg", image_name:"", is_main_image: true, project: p2)
ProjectItem.create(image_url: "../images/CMBN_AlamoCityTX_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_AustinTX_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_BatonRougeLA_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_ColumbiaSC_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_DallasTX_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_OklahomaCityOK_1200.jpg", image_name:"", is_main_image: false, project: p2)
ProjectItem.create(image_url: "../images/CMBN_TwinCitiesMN_1200.jpg", image_name:"", is_main_image: false, project: p2)
